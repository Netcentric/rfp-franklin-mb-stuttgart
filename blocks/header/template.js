const navTemplate = ({ path, title }, index) => `<li
    data-v-66b06a6d=""
    role="none"
    class="owc-header-navigation-topic owc-header-navigation-topic--desktop-nav ${index === 0 ? 'owc-header-navigation-topic__model-flyout' : ''}"
    dir="ltr"
  >
    <!----><a
    href="${path}"
      aria-haspopup="true"
      role="menuitem"
      class="owc-header-navigation-topic__button"
    >
      <wb-icon
        aria-hidden="true"
        name="bds/car/24"
        class="owc-header-navigation-topic__desktop-models-icon hydrated"
        ><svg
      ...
      <p class="owc-header-navigation-topic__label">${title}</p>
      <div class="owc-header-navigation-topic__icon-wrapper">
        <wb-icon
          aria-hidden="true"
          name="bds/chevron-right/16"
          flip-rtl=""
          class="wb-round-button__icon hydrated"
          ><svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 16 16"
          >
            <path
              d="M5 11.893l4.949-4.95 1.06 1.06-4.95 4.95z"
            ></path>
            <path
              d="M4.99 4.178l1.061-1.061 4.95 4.95-1.06 1.06z"
            ></path>
          </svg>
        </wb-icon>
      </div></a>
...
<div class="root responsivegrid owc-content-container">
  <div class="aem-Grid aem-Grid--12 aem-Grid--default--12">
    <owc-header
      class="webcomponent aem-GridColumn aem-GridColumn--default--12 XXsnipcss_extracted_selector_selectionXX snipcss0-0-0-1 tether-target-attached-top tether-element-attached-top tether-element-attached-center tether-target-attached-center"
    >
      <header class="owc-header" dir="ltr" data-tracking-action="owc-header">
        <div class="owc-header__wrapper">
          <a href="#first-web-component" class="owc-header__skip-to-content">
            Skip to content
          </a>
          <nav class="owc-header__top">
            <button
              aria-label="Menü"
              class="owc-header-button__iconWrapper owc-header__item-menu"
            >
              <wb-icon
                name="bds/menu/16"
                class="owc-header-button__icon--small hydrated"
                aria-hidden="true"
                ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                  <path d="M1 7h14v2H1zm0-4h14v2H1zm0 8h14v2H1z"></path>
                </svg>
              </wb-icon></button
            ><button
              aria-label="menu"
            ...
            >
              <wb-icon
                name="bds/car/24"
                class="owc-header-button__icon hydrated"
                aria-hidden="true"
            ...
            <a
              href="/"
              target="_self"
              class="owc-header__logo-and-claim-anchor"
              ><div class="owc-header__logo-wrapper">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="64"
                  height="64"
                  viewBox="0 0 64 64"
                  class="owc-header__star"
                >
                  <defs>
                    <linearGradient
                      id="a"
              ...
              <div class="owc-header__claim-wrapper">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="111"
                  height="13"
                  viewBox="0 0 111 13"
                  class="owc-header__claim"
                >
            ...
            ></a>
            <div class="owc-header__language-and-imprint">
              <a
                target="_self"
                href="/content-pool/tool-pages/legal/copyright.html"
                class="owc-header__item-imprint"
              >
                Anbieter/Datenschutz </a
              ><!---->
            </div>
            <div class="owc-header__top-menu-tools">
              <!---->
              <div class="owc-header__item-container">
                <!----><!----><!----><!----><!---->
              </div>
            </div>
          </nav>
          <nav class="owc-header__header-navigation">
            <div
              data-v-66b06a6d=""
              class="owc-header-main-navigation__desktop-wrapper"
              dir="ltr"
            >
              <!---->
              <ul
